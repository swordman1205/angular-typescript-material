...
describe('Image Service', () => {
    ...
    beforeEach(() => {
        ...
        angular.mock.inject((_$httpBackend_, _imageService_, _$q_, _ngRestAdapter_, _$rootScope_, _$timeout_) => {
        ...
        (<any>Config).CLOUDINARY_CLOUD_NAME = 'iquitsugar';
        (<any>Config).CLOUDINARY_ENDPOINT = 'https://api.cloudinary.com/v1_1';
    ...
    describe('Image upload', () => {
        ...
        it('should be able to upload an image to cloudinary', () => {
            ...
            $httpBackend.expectPOST('https://api.cloudinary.com/v1_1/iquitsugar/image/upload').respond({ //as the request is a FormObject, for some reason httpbackend won't passthrough the request body so assertions can't be added
                bytes: 517112,
                ...
                resource_type: "image",
                secure_url: `https://res.cloudinary.com/iquitsugar/image/upload/v${ts}/${fixedImageId}.jpg`,
                signature: "3c2255855ac023ff1bde0faa454667e9494152a6",
                tags: [],
                type: "upload",
                url: `http://res.cloudinary.com/iquitsugar/image/upload/v${ts}/${fixedImageId}.jpg`,
                version: ts,
                width: 2448,
            });
            ...
            expect(uploadPromise).eventually.to.be.instanceOf(Image);
        ...
        it('should notify progress on upload', () => {
            ...
            uploadPromise.then(() => {
                ...
                progressSpy.should.have.been.calledWith(sinon.match({
    ...
    describe('Image retrieval', () => {
        ...
        let images = _.clone(ImageMock.collection(10)); //get a set of images
