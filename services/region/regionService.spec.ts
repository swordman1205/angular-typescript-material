    ...
    beforeEach(() => {
        ...
        angular.mock.module(($provide) => {
            $provide.decorator('ngJwtAuthService', function ($delegate:any) {
                ...
                $delegate.registerLoginListener.onCall(0).yields(UserMock.entity({regionCode: 'au'}));

                return $delegate;
            });
        });

        angular.mock.inject((_$httpBackend_, _regionService_, _ngRestAdapter_, _$rootScope_, _$timeout_) => {
