...
import {INgRestAdapterRequestConfig} from "angular-rest-adapter";
type IRequestConfig = ng.IRequestConfig & INgRestAdapterRequestConfig;

export default class RegionInterceptor {
    ...
    private getRegionService = ():RegionService => {
        if (this.regionService == null) {
            this.regionService = this.$injector.get<RegionService>('regionService');
        }
